all : autoconf avro aws-sdk-cpp boost catch2 clang clang-runtime cmake cpr cpython elasticlient imagemagick jansson json libarchive libs3 mungefs qpid qpid-proton qpid-with-proton redis zeromq4-1 cppzmq epm
